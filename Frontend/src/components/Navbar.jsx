...
function Navbar() {
  ...
  return (
    <>
       ...
       <div className={`dark:bg-slate-900 dark:text-white max-w-screen-2xl container-auto md:px-20 px-4 mb-0 fixed top-0 left-0 right-0 z-50 ${sticky ? "sticky-navbar shadow-md bg-base-200 dark:bg:slate-600 duration-300 transition-all ease-in-out" : ""}`}>
